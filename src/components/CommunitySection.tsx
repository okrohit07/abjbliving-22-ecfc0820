  ...
  return <div className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto font-normal text-sm text-center">En ABJB formarás parte de una comunidad exclusiva compuesta por personas que comparten una misma visión de vida. Más que un lugar para vivir, es un espacio para conectar, crecer y compartir experiencias con personas afines, en un entorno diseñado para inspirar relaciones auténticas y                                                                        un estilo de vida premium.                                                                                                                                                                              
