  ...
  return <section className="relative bg-black text-white py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8 text-sm md:text-sm">Únete a nuestra comunidad exclusiva y experimenta un nuevo nivel de vida de lujo con tecnología de vanguardia y compromiso con la sostenibilidad.</p>
