    ...
    <section className="relative bg-black text-white py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-serif mb-6">Ready to Find Your Perfect Space?</h2>
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            Join our vibrant community of like-minded individuals and experience the next level of modern living.
          </p>
          <Link
            to="/find-room"
            className="inline-flex items-center bg-white text-black px-6 py-3 font-medium hover:bg-white/90 transition"
          >
            FIND YOUR ROOM <ArrowRight size={16} className="ml-2" />
          </Link>
        </div>
      </div>
    </section>
